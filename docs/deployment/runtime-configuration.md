...
| `BETTERBOOKING_AUTH_SCOPES` | Yes for auth | No | Must include OIDC scopes and the backend API scope. |
...
- Frontend: `NODE_ENV`, `BETTERBOOKING_API_BASE_URL`, `BETTERBOOKING_WEB_BASE_URL`, `BETTERBOOKING_AUTH_ISSUER`, `BETTERBOOKING_AUTH_CLIENT_ID`, `BETTERBOOKING_AUTH_SCOPES`, `BETTERBOOKING_AUTH_COOKIE_SECRET`, optional `BETTERBOOKING_AUTH_CLIENT_SECRET`, `WEBSITE_RUN_FROM_PACKAGE`.
